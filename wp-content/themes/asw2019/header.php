...
<body id="<?php echo $post->post_name; ?>" class="onethirtyeight <?php echo get_post_type(); ?>">
...
<header>
   <section class="titles">
    <a class="home" href="<?php echo get_bloginfo('wpurl'); ?>">
      <h1><?php echo get_bloginfo('name'); ?></h1>
    </a>
    <?php if (! is_home() ) {
      echo '<span class="divider">&raquo;</span><h2>' . get_the_title() . '</h2>';
    } ?>
  </section>
</header>
